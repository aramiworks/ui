...
const specs = [
  ...
  { property: "Selected color", value: "primary" },
  { property: "Unselected color", value: "onSurfaceVariant" },
...
const meta: Meta = {
  ...
  parameters: {
    design: {
      type: "figma",
      url: "https://www.figma.com/design/b79qv459pnXaypgNQfNXuc/atoms?node-id=1690-21",
    },
  },
};
